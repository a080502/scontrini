...
foreach ($attivita as $scontrino) {
    ...
    $eventi[] = [
        ...
        'tipo' => 'creazione',
        'scontrino' => $scontrino,
        'descrizione' => "Scontrino '{$scontrino['nome_display']}' creato$user_info"
    ];
    ...
    if ($scontrino['data_incasso']) {
        $eventi[] = [
            ...
            'tipo' => 'incasso',
            'scontrino' => $scontrino,
            'descrizione' => "Scontrino '{$scontrino['nome_display']}' incassato$user_info"
        ];
    }
    ...
    if ($scontrino['data_versamento']) {
        $eventi[] = [
            ...
            'tipo' => 'versamento',
            'scontrino' => $scontrino,
            'descrizione' => "Scontrino '{$scontrino['nome_display']}' versato$user_info"
        ];
    }
    ...
    if ($scontrino['data_archiviazione']) {
        $eventi[] = [
            ...
            'tipo' => 'archiviazione',
            'scontrino' => $scontrino,
            'descrizione' => "Scontrino '{$scontrino['nome_display']}' archiviato$user_info"
        ];
    }
}
