...
if (Auth::isAdmin()) {
    $utenti = $db->fetchAll("
        SELECT u.*, f.nome as filiale_nome,
               (SELECT COUNT(*) FROM scontrini s WHERE s.utente_id = u.id AND s.stato != 'archiviato') as scontrini_count
        FROM utenti u
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-3">
                            <div class="card bg-success text-white">
                                <div class="card-body text-center">
                                    <h4><?= count(array_filter($utenti, function($u) { return $u['ruolo'] === 'admin'; })) ?></h4>
                        ...
                        <div class="col-md-3">
                            <div class="card bg-info text-white">
                                <div class="card-body text-center">
                                    <h4><?= count(array_filter($utenti, function($u) { return $u['ruolo'] === 'responsabile'; })) ?></h4>
                        ...
                        <div class="col-md-3">
                            <div class="card bg-warning text-white">
                                <div class="card-body text-center">
                                    <h4><?= count(array_filter($utenti, function($u) { return $u['ruolo'] === 'utente'; })) ?></h4>
                                    <small>Utenti</small>
                                </div>
                            </div>
                        </div>
